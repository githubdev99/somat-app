...
export default function Content(props) {
  ...
  return (
    <div className="flex h-full flex-col lg:pl-[230px]">
      <div className="sticky top-0 z-40 flex h-12 shrink-0 items-center gap-x-4 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-6">
        <div className="flex w-full flex-row items-center justify-between gap-2 rounded-lg transition duration-200 ease-in">
          <div className="flex cursor-text flex-row items-center gap-1 rounded-lg px-2 transition duration-200 ease-in hover:bg-[#181818] active:opacity-80">
            <div
                ...
                <table className="min-w-full divide-y divide-[rgba(255,255,255,.1)] text-left align-top">
                  <thead className="whitespace-nowrap text-[rgba(255,255,255,.4)]">
                    <tr>
                      <th
                        scope="col"
                        className="px-3 py-2 font-normal text-[rgba(255,255,255,.9)]"
                      >
                        Tasks
                      </th>
                  ...
                  <tbody className="divide-y divide-[rgba(255,255,255,.1)] text-[rgba(255,255,255,.9)]">
                    {projectListExamples.map((item, index) => {
                      ...
                      return (
                        <tr key={index}>
                          <td className="relative cursor-pointer whitespace-nowrap rounded-lg px-3 py-2 text-sm text-gray-300 transition duration-100 ease-in hover:bg-[#414141]">
                            {name}
                          </td>
                          <td
                          ...
                          >
                            <Global.Dropdown
                              ...
                              fullWidth={true}
                              forceOverlap={true}
                              className="relative cursor-pointer rounded-lg px-3 py-2 text-sm text-gray-300 transition duration-100 ease-in hover:bg-[#414141]"
                            >
                              {status}
                            </Global.Dropdown>
                          </td>
