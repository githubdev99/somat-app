...
export default function Lists(props) {
  const { setSidebarOpen, openTaskDetail, setOpenTaskDetail } = props;

  const getAssignees = [
    {
      name: "Devan",
      image:
        "https://imageproxy.height.app/240/https%3A%2F%2Ffiles.height.app%2Fe248e474-5297-48fc-b7f8-d28971bbf489.jpg",
    },
    {
      name: "Rizky",
      image:
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className="relative cursor-pointer whitespace-nowrap text-sm text-gray-300">
                            ...
                            >
                              <Global.Badge text={status} hexColor="#f6b065" />
                            </Global.Dropdown>
                          </td>
                          <td className="relative cursor-pointer whitespace-nowrap text-sm text-gray-300">
                            <Global.Dropdown
                              items={getAssignees.map((getAssign, index) => {
